...
dlmwrite('../common/A.txt', A_file, 'delimiter', '', 'newline', 'unix');
dlmwrite('../common/B.txt', B_file, 'delimiter', '', 'newline', 'unix');
dlmwrite('../common/C.txt', C_file, 'delimiter', '', 'newline', 'unix');
dlmwrite('../common/sign.txt', sign_file, 'delimiter', '', 'newline', 'unix');
...
if(matches == ones(2*N, 1))
    ...
    disp("Sorry... You have to spend your night debugging your design u.u")
end 